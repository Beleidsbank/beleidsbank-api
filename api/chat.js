...
module.exports = async (req,res)=>{
  ...
  try{
    ...
    const hasLaw =
      qLower.includes("awb") ||
      qLower.includes("omgevingswet") ||
      qLower.includes("bal");

    if(articleMatch && !hasLaw){
    ...
    const context = results
      .map((r,i)=>{
        ...
        const txt =
          cleanLegalText((r.text || "").slice(0,700));
