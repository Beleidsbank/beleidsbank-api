// beleidsbank-api/api/ingest-bwb-official.js
// OFFICIËLE BWB XML ingest (repository.overheid.nl)
// Production-grade bron
...
module.exports=async(req,res)=>{
  ...
  try{
    ...
    const xmlUrl=`https://repository.overheid.nl/frbr/officielepublicaties/bwb/${id}/xml/${id}.xml`;
